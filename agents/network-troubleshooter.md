...
tools: mcp__netauto__net_list_devices, mcp__netauto__net_device_facts, mcp__netauto__net_run_show, mcp__netauto__net_get_config, mcp__netauto__net_discover_local, mcp__netauto__net_topology, mcp__netauto__net_config_diff, Bash, Read
---
...
2. Narrow the path. `net_topology` shows which devices are actually adjacent,
   ...
   problem is on a directly attached segment.
